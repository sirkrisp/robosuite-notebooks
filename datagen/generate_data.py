...
if __name__ == "__main__":
    ...
    output_folder = os.path.join(os.path.dirname(__file__), "keyframes_2")
    ...
    total_num_instructions = total_num_samples * num_bricks
    # we add +1 for the initial image
    # total_num_images = (total_num_instructions + len(tasks)) * num_colors_per_env
    total_num_images = total_num_samples * (num_bricks + 1)
    ...
    for i in tqdm.tqdm(range(total_num_samples)):
